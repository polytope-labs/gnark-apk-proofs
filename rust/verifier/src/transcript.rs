...
///   "gamma" (5 bytes) || 9 VK G1 points (9×96=864) || nb_qcp G1 points || PI (n×32) || LRO (3×96=288)
...
pub fn derive_gamma_kzg(
    ...
    // commitment is stored in STATE_LINEARISED_POLYNOMIAL as [x_hi(16)||x_lo(32)||y_hi(16)||y_lo(32)],
    // and only the 48-byte portions (offset+0x10 for 0x30 bytes each) are hashed.
