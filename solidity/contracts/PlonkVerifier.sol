...
contract PlonkVerifier {
  ...
  uint256 private constant G2_SRS_1_X_0_lo = 98818261219665556820116393326710283728194613277906692746999383494736488566849;
	uint256 private constant G2_SRS_1_X_0_hi = 6702007575715075320260787041282023974;
  uint256 private constant G2_SRS_1_X_1_lo = 107295074956447986529499398282537175562686944614009760601532638792775151105441;
  uint256 private constant G2_SRS_1_X_1_hi = 23095680094956914720643271362915338617;
  uint256 private constant G2_SRS_1_Y_0_lo = 8594986162647929224598689359123507863380823404425048524967989070164894254109;
  uint256 private constant G2_SRS_1_Y_0_hi = 5726332817694702460752566844701475736;
  uint256 private constant G2_SRS_1_Y_1_lo = 91300969265257680946581081952456532887094893522716738863049529967274783452774;
  ...
  // ----------------------- vk ---------------------
  uint256 private constant VK_NB_PUBLIC_INPUTS = 18;
  uint256 private constant VK_DOMAIN_SIZE = 8388608;
  uint256 private constant VK_INV_DOMAIN_SIZE = 52435868924282763879207214374679607192017058436845975677032209586610279285249;
  uint256 private constant VK_OMEGA = 52167942466760591552294394977846462646742207006759917080697723404762651336366;
  uint256 private constant VK_QL_COM_X_lo = 100734657052455073122775902273610509968420132478388527521127709054371717093008;
	uint256 private constant VK_QL_COM_X_hi = 1273773916244348214278079803081150166;
  uint256 private constant VK_QL_COM_Y_lo = 13555593940500226305228253953488868882802846934944080226751344961028977750961;
  uint256 private constant VK_QL_COM_Y_hi = 11344120512551433718680479174505558873;
  uint256 private constant VK_QR_COM_X_lo = 34015829137043516184185087778382013664983913341447914863510455279373689006634;
  uint256 private constant VK_QR_COM_X_hi = 9424591151393086088412266439979540303;
  uint256 private constant VK_QR_COM_Y_lo = 9297562062756805486733257975773426693440031840900802241829832958358997763622;
  uint256 private constant VK_QR_COM_Y_hi = 16267045111334661040524713256320559260;
  uint256 private constant VK_QM_COM_X_lo = 64687160734635210297530471953001006100570034047948542548247005196669505051803;
  uint256 private constant VK_QM_COM_X_hi = 23811536650533207755841142883831044410;
  uint256 private constant VK_QM_COM_Y_lo = 44060658802983236979024808452511068390614292827893522144397799203560298135951;
  uint256 private constant VK_QM_COM_Y_hi = 30456975702716084949609039097591023749;
  uint256 private constant VK_QO_COM_X_lo = 9234887032547599724723998730670146775554092088542188833731345742660301695892;
  uint256 private constant VK_QO_COM_X_hi = 23348512476969545287320249372585611176;
  uint256 private constant VK_QO_COM_Y_lo = 7518895237899528129507298216994530360968558899638309531202247520438824510616;
  uint256 private constant VK_QO_COM_Y_hi = 26944950833464070379812207975853425456;
  uint256 private constant VK_QK_COM_X_lo = 18960341261285907315563343396802746158724586976598248120380320321162914798083;
  uint256 private constant VK_QK_COM_X_hi = 12544382263114660079044269344755693662;
  uint256 private constant VK_QK_COM_Y_lo = 61459304839107432093283066143348775360285791922696325274348370537599690324138;
  uint256 private constant VK_QK_COM_Y_hi = 27358325706009370932066079500390763429;
  
  uint256 private constant VK_S1_COM_X_lo = 110153170114330076481445189424235440804931551020185997782636193908085512774821;
	uint256 private constant VK_S1_COM_X_hi = 24411399292243437435828177103272497560;
  uint256 private constant VK_S1_COM_Y_lo = 10021212874854350353958618872832933728621839950300204457966071463481352987664;
  uint256 private constant VK_S1_COM_Y_hi = 30977551166890188679264724218642106536;
  
  uint256 private constant VK_S2_COM_X_lo = 13685451378424409836965270565630549315746860832836809144441661710373480333343;
	uint256 private constant VK_S2_COM_X_hi = 25521992160225670075842945691497113077;
  uint256 private constant VK_S2_COM_Y_lo = 103899719564828630115483837795134319624452346072944825592039670641383062518380;
  uint256 private constant VK_S2_COM_Y_hi = 31833565841618499238134405197175457135;
  
  uint256 private constant VK_S3_COM_X_lo = 108730051514052229714303470385938626495092200255741923472986679685400497954443;
	uint256 private constant VK_S3_COM_X_hi = 21652610759386445798431194650033479084;
  uint256 private constant VK_S3_COM_Y_lo = 4081669815262011777258654111680011472991919409519741837749540948840185084088;
  uint256 private constant VK_S3_COM_Y_hi = 23470322605412197478862066238718642126;
  
  uint256 private constant VK_COSET_SHIFT = 7;
  
  
  uint256 private constant VK_QCP_0_X_lo = 107057636451238969968101537196851088443481559262224222718848189014638358532315;
	uint256 private constant VK_QCP_0_X_hi = 30007386019357209387496120436882668120;
  uint256 private constant VK_QCP_0_Y_lo = 100671008633741387604158506676871160426982889561584418719633811373123604509014;
  uint256 private constant VK_QCP_0_Y_hi = 2230691496200644150714194710227038320;
  
  
  uint256 private constant VK_INDEX_COMMIT_API_0 = 5162018;
  ...
  function Verify(bytes calldata proof, uint256[18] calldata public_inputs)
  public view returns(bool success) {
    ...
    assembly {
      ...
      // sanity checks
      check_number_of_public_inputs(VK_NB_PUBLIC_INPUTS)
      check_inputs_size(VK_NB_PUBLIC_INPUTS, public_inputs)
      check_proof_size(proof.length)
      check_proof_openings_size(proof.offset)

      // compute the challenges
      let prev_challenge_non_reduced
      prev_challenge_non_reduced := derive_gamma(proof.offset, VK_NB_PUBLIC_INPUTS, public_inputs)
      ...
      let l_pi := sum_pi_wo_api_commit(public_inputs, VK_NB_PUBLIC_INPUTS, freeMem)
